  ...
  */
  ...
  (0, _createClass2.default)(UpdateManager, [{
    ...
    value: function editable(uri, kb) {
      ...
      var requests = kb.each(undefined, this.ns.link('requestedURI'), (0, _uri.docpart)(uri)); // This if-statement does not follow the Solid spec, but temporarily reverts this change:
    ...
    value: function reload(kb, doc, callbackFunction) {
      ...
      kb.fetcher.nowOrWhenFetched(doc.value, options, function (ok, body, response) {
        if (!ok) {
          ...
          console.log('    Non-HTTP error reloading data! onErrorWasCalled=' + //@ts-ignore Where does onErrorWasCalled come from?
