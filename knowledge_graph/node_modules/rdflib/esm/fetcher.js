...
import serialize from './serialize'; // @ts-ignore This is injected

import { fetch as solidAuthCli } from 'solid-auth-cli'; // @ts-ignore This is injected
...
var fetch = typeof window === 'undefined' ? solidAuthCli : solidAuthClient;
var Parsable = {
  'text/n3': true,
  'text/turtle': true,
...
var TextHandler = /*#__PURE__*/function (_Handler5) {
  _inherits(TextHandler, _Handler5);

  var _super5 = _createSuper(TextHandler);
...
var N3Handler = /*#__PURE__*/function (_Handler6) {
  _inherits(N3Handler, _Handler6);

  var _super6 = _createSuper(N3Handler);
  ...
  _createClass(Fetcher, [{
    ...
    */
    ...
    value: function getHeader(doc, header) {
      var kb = this.store;
      var requests = kb.each(undefined, this.ns.link('requestedURI'), doc);
