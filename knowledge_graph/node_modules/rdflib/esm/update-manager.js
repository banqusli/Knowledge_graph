  ...
  */
  ...
  _createClass(UpdateManager, [{
    ...
    value: function editable(uri, kb) {
      ...
      var requests = kb.each(undefined, this.ns.link('requestedURI'), docpart(uri)); // This if-statement does not follow the Solid spec, but temporarily reverts this change:
