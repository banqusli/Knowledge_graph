...
var Formula = /*#__PURE__*/function (_Node) {
  ...
  */
  function Formula(statements, constraints, initBindings, optional) {
    ...
    _defineProperty(_assertThisInitialized(_this), "constraints", void 0);

    _defineProperty(_assertThisInitialized(_this), "fetcher", void 0);

    _defineProperty(_assertThisInitialized(_this), "initBindings", void 0);

    _defineProperty(_assertThisInitialized(_this), "isVar", 0);

    _defineProperty(_assertThisInitialized(_this), "ns", Namespace);

    _defineProperty(_assertThisInitialized(_this), "optional", void 0);

    _defineProperty(_assertThisInitialized(_this), "rdfFactory", void 0);

    _defineProperty(_assertThisInitialized(_this), "statements", void 0);
