...
export declare type PolarPositionChannel = 'theta' | 'theta2' | 'radius' | 'radius2';
 ...
 */
export declare const SINGLE_DEF_CHANNELS: ("stroke" | "color" | "shape" | "text" | "x" | "y" | "x2" | "y2" | "longitude" | "latitude" | "theta" | "theta2" | "radius" | "radius2" | "longitude2" | "latitude2" | "fill" | "opacity" | "fillOpacity" | "strokeOpacity" | "strokeWidth" | "strokeDash" | "size" | "angle" | "key" | "href" | "url" | "facet" | "row" | "column")[];
export declare type SingleDefChannel = typeof SINGLE_DEF_CHANNELS[number];
export declare const SINGLE_DEF_UNIT_CHANNELS: ("stroke" | "color" | "shape" | "text" | "x" | "y" | "x2" | "y2" | "longitude" | "latitude" | "theta" | "theta2" | "radius" | "radius2" | "longitude2" | "latitude2" | "fill" | "opacity" | "fillOpacity" | "strokeOpacity" | "strokeWidth" | "strokeDash" | "size" | "angle" | "key" | "href" | "url")[];
 ...
 */
export declare function getMainRangeChannel<C extends Channel>(channel: C): C | 'x' | 'y' | 'latitude' | 'longitude';
/**
 * Get the main channel for a range channel. E.g. `x` for `x2`.
 */
export declare function getSecondaryRangeChannel(channel: Channel): SecondaryRangeChannel;
/**
 * Get the main channel for a range channel. E.g. `x` for `x2`.
 */
...
export declare const UNIT_CHANNELS: ("stroke" | "color" | "shape" | "text" | "x" | "y" | "x2" | "y2" | "longitude" | "latitude" | "theta" | "theta2" | "radius" | "radius2" | "longitude2" | "latitude2" | "fill" | "opacity" | "fillOpacity" | "strokeOpacity" | "strokeWidth" | "strokeDash" | "size" | "angle" | "detail" | "key" | "tooltip" | "href" | "url" | "order")[];
export declare const NONPOSITION_CHANNELS: ("stroke" | "color" | "shape" | "text" | "fill" | "opacity" | "fillOpacity" | "strokeOpacity" | "strokeWidth" | "strokeDash" | "size" | "angle" | "detail" | "key" | "tooltip" | "href" | "url" | "order")[];
...
export declare type PositionScaleChannel = typeof POSITION_SCALE_CHANNELS[number];
export declare const POLAR_POSITION_SCALE_CHANNELS: ("theta" | "radius")[];
export declare type PolarPositionScaleChannel = typeof POLAR_POSITION_SCALE_CHANNELS[number];
export declare function getSizeType(channel: PositionScaleChannel): 'width' | 'height';
