...
export declare function labelAngle(model: UnitModel, specifiedAxis: Axis, channel: PositionScaleChannel, fieldOrDatumDef: TypedFieldDef<string> | DatumDef, axisConfigTypes: string[]): number;
...
export declare function values(specifiedAxis: Axis, fieldOrDatumDef: TypedFieldDef<string> | DatumDef): SignalRef | (string | number | boolean | import("../../datetime").DateTime | {
    signal: string;
})[];
