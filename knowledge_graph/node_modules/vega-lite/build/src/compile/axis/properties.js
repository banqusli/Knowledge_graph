...
export function labelAngle(model, specifiedAxis, channel, fieldOrDatumDef, axisConfigTypes) {
    // try axis value
    if ((specifiedAxis === null || specifiedAxis === void 0 ? void 0 : specifiedAxis.labelAngle) !== undefined) {
        ...
        const { configValue: angle } = getAxisConfig('labelAngle', model.config, axisConfigTypes, specifiedAxis === null || specifiedAxis === void 0 ? void 0 : specifiedAxis.style);
        if (angle !== undefined) {
