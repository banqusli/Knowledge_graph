...
import { isPolarPositionChannel, X, X2, Y2 } from '../../../channel';
import { getBand, isAnyPositionFieldOrDatumDef, isFieldDef, isFieldOrDatumDef, isValueDef } from '../../../channeldef';
...
export function rectPosition(model, channel, mark) {
    ...
    const hasSizeDef = (_d = (_c = (_b = (_a = encoding[sizeChannel]) !== null && _a !== void 0 ? _a : encoding.size) !== null && _b !== void 0 ? _b : markDef[sizeChannel]) !== null && _c !== void 0 ? _c : markDef.size) !== null && _d !== void 0 ? _d : getMarkConfig('size', markDef, config, { vgChannel: sizeChannel });
...
export function rectBinPosition({ fieldDef, fieldDef2, channel, vgChannel, vgChannel2, band, scaleName, markDef, spacing = 0, reverse, config }) {
    const channel2 = channel === X ? X2 : Y2;
    ...
    if (isBinning(fieldDef.bin) || fieldDef.timeUnit) {
        ...
        return {
            [vgChannel2]: ref.valueRefForFieldOrDatumDef(fieldDef, scaleName, {}, { offset: getBinSpacing(channel2, spacing, reverse) }),
            [vgChannel]: ref.valueRefForFieldOrDatumDef(fieldDef2, scaleName, {}, { offset: getBinSpacing(channel, spacing, reverse) })
        };
    }
    else {
