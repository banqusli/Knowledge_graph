...
import { getValueFromMarkDefAndConfig } from './valueref';
...
export function arcRangePosition(model, { channel, vgChannel, vgChannel2, defaultRef }) {
    ...
    return {
        [vgChannel]: positionRef(Object.assign(Object.assign({}, sharedParams), { defaultRef: defaultValue ? { value: defaultValue } : defaultRef })),
        [vgChannel2]: position2Ref(Object.assign(Object.assign({}, sharedParams), { channel: channel2, defaultRef: { value: defaultValue2 !== null && defaultValue2 !== void 0 ? defaultValue2 : 0 } }))
    };
}
export function arcPointPosition(channel, model) {
    const { encoding, markDef, stack, config } = model;
...
//# sourceMappingURL=position-arc.js.map