...
export function initMarkdef(mark, encoding, config, { graticule }) {
    ...
    const specifiedOrient = (_a = markDef.orient) !== null && _a !== void 0 ? _a : getMarkConfig('orient', markDef, config);
    markDef.orient = orient(markDef.type, encoding, specifiedOrient);
    if (specifiedOrient !== undefined && specifiedOrient !== markDef.orient) {
        log.warn(log.message.orientOverridden(markDef.orient, specifiedOrient));
    }
    if (markDef.type === 'bar' && markDef.orient) {
        const cornerRadiusEnd = (_b = markDef.cornerRadiusEnd) !== null && _b !== void 0 ? _b : getMarkConfig('cornerRadiusEnd', // FIXME: make the typing work with getMarkConfig()
        markDef, config);
    ...
    const specifiedCursor = (_c = markDef.cursor) !== null && _c !== void 0 ? _c : getMarkConfig('cursor', markDef, config);
