...
export declare function applyMarkConfig(e: VgEncodeEntry, model: UnitModel, propsList: (keyof MarkConfig)[]): Partial<Record<import("../vega.schema").VgEncodeChannel, import("../vega.schema").VgValueRef | (import("../vega.schema").VgValueRef & {
    test?: string;
})[]>>;
...
export declare function getMarkStyleConfig<P extends keyof AnyMarkConfig>(prop: P, mark: MarkDef, styleConfigIndex: StyleConfigIndex): any;
export declare function getStyleConfig<P extends keyof AnyMarkConfig | keyof Axis>(p: P, styles: string | string[], styleConfigIndex: StyleConfigIndex): any;
/**
