...
export declare type Value = number | string | boolean | number[] | null;
export { Gradient };
 ...
 */
export declare type ChannelDefWithCondition<F extends FieldDef<any> | DatumDef, V extends ValueOrGradientOrText = Value> = FieldOrDatumDefWithCondition<F, V> | ValueDefWithCondition<F, V> | SignalRefWithCondition<F, V>;
/**
 ...
 * @minProperties 1
 */
export declare type ValueDefWithCondition<F extends FieldDef<any> | DatumDef<any>, V extends ValueOrGradientOrText = Value> = Partial<ValueDef<V>> & {
    /**
 ...
 * @hidden
 */
export declare type SignalRefWithCondition<F extends FieldDef<any> | DatumDef, V extends ValueOrGradientOrText = Value> = SignalRef & {
    /**
     * A field definition or one or more value definition(s) with a selection predicate.
     */
    condition?: Conditional<F> | ValueOrSignalCondition<V>;
};
export declare type ValueOrSignalDefWithCondition<F extends FieldDef<any> | DatumDef<any>, V extends ValueOrGradientOrText = Value> = ValueDefWithCondition<F, V> | SignalRefWithCondition<F, V>;
export declare type StringValueOrSignalDefWithCondition<F extends Field, T extends Type = StandardType> = ValueOrSignalDefWithCondition<MarkPropFieldOrDatumDef<F, T>, string | null>;
export declare type ColorGradientValueOrSignalDefWithCondition<F extends Field, T extends Type = StandardType> = ValueOrSignalDefWithCondition<MarkPropFieldOrDatumDef<F, T>, Gradient | string | null>;
export declare type NumericValueOrSignalDefWithCondition<F extends Field> = ValueOrSignalDefWithCondition<MarkPropFieldOrDatumDef<F, StandardType>, number>;
export declare type NumericArrayValueOrSignalDefWithCondition<F extends Field> = ValueOrSignalDefWithCondition<MarkPropFieldOrDatumDef<F, StandardType>, number[]>;
export declare type TypeForShape = 'nominal' | 'ordinal' | 'geojson';
export declare type ShapeValueOrSignalDefWithCondition<F extends Field> = StringValueOrSignalDefWithCondition<F, TypeForShape>;
export declare type TextValueOrSignalDefWithCondition<F extends Field> = ValueOrSignalDefWithCondition<StringFieldDef<F>, Text>;
...
export declare type ValueOrSignalCondition<V extends ValueOrGradientOrText = Value> = Conditional<ValueDef<V>> | Conditional<ValueDef<V>>[] | Conditional<SignalRef> | Conditional<SignalRef>[];
 ...
 * }
 */
export declare type FieldOrDatumDefWithCondition<F extends FieldDef<any, any> | DatumDef<any>, V extends ValueOrGradientOrText = Value> = F & ConditionValueDefMixins<V>;
export declare type ColorGradientFieldDefWithCondition<F extends Field> = FieldOrDatumDefWithCondition<MarkPropFieldDef<F, StandardType>, Gradient | string | null>;
export declare type ColorGradientDatumDefWithCondition<F extends Field> = FieldOrDatumDefWithCondition<DatumDef<F>, Gradient | string | null>;
export declare type NumericFieldDefWithCondition<F extends Field> = FieldOrDatumDefWithCondition<MarkPropFieldDef<F, StandardType>, number>;
export declare type NumericDatumDefWithCondition<F extends Field> = FieldOrDatumDefWithCondition<DatumDef<F>, number>;
export declare type NumericArrayFieldDefWithCondition<F extends Field> = FieldOrDatumDefWithCondition<MarkPropFieldDef<F, StandardType>, number[]>;
export declare type NumericArrayDatumDefWithCondition<F extends Field> = FieldOrDatumDefWithCondition<DatumDef<F>, number[]>;
export declare type ShapeFieldDefWithCondition<F extends Field> = FieldOrDatumDefWithCondition<MarkPropFieldDef<F, TypeForShape>, string | null>;
export declare type TextFieldDefWithCondition<F extends Field> = FieldOrDatumDefWithCondition<StringFieldDef<F>, Text>;
export declare type StringFieldDefWithCondition<F extends Field> = FieldOrDatumDefWithCondition<StringFieldDef<F>, string>;
export declare type StringDatumDefWithCondition<F extends Field> = FieldOrDatumDefWithCondition<DatumDef<F>, string>;
/**
...
export interface DatumDef<F extends Field = string, V extends Value | DateTime = Value | DateTime> extends Partial<TypeMixins<Type>> {
    /**
...
export declare type PolarFieldDef<F extends Field> = PositionFieldDefBase<F>;
export declare type PolarDatumDef<F extends Field> = PositionDatumDefBase<F>;
...
export declare function isConditionalDef<CD extends ChannelDef<any> | GuideEncodingConditionalValueDef>(channelDef: CD): channelDef is CD & {
    condition: Conditional<any>;
};
/**
 * Return if a channelDef is a ConditionalValueDef with ConditionFieldDef
 */
export declare function hasConditionalFieldDef<F extends Field>(channelDef: ChannelDef<F>): channelDef is {
...
export declare function isFieldDef<F extends Field>(channelDef: ChannelDef<F> | FieldDefBase<F> | DatumDef<F, any>): channelDef is FieldDefBase<F> | TypedFieldDef<F> | SecondaryFieldDef<F>;
export declare function channelDefType<F extends Field>(channelDef: ChannelDef<F>): Type | undefined;
export declare function isDatumDef<F extends Field>(channelDef: ChannelDef<F> | FieldDefBase<F> | DatumDef<F, any>): channelDef is DatumDef<F, any>;
export declare function isContinuousFieldOrDatumDef<F extends Field>(cd: ChannelDef<F>): boolean;
...
export declare function isFieldOrDatumDef<F extends Field>(channelDef: ChannelDef<F>): channelDef is FieldDef<F, any> | DatumDef<F>;
export declare function isTypedFieldDef<F extends Field>(channelDef: ChannelDef<F>): channelDef is TypedFieldDef<F>;
export declare function isValueDef<F extends Field>(channelDef: ChannelDef<F>): channelDef is ValueDef<any>;
...
export declare function isAnyPositionFieldOrDatumDef<F extends Field>(channelDef: ChannelDef<F>): channelDef is PositionFieldDefBase<F> | PositionDatumDefBase<F>;
...
export declare function isTextFieldDef<F extends Field>(channelDef: ChannelDef<F>): channelDef is StringFieldDef<F>;
...
export declare function getFormatMixins(fieldDef: TypedFieldDef<string>): {
 ...
 */
export declare function initChannelDef(channelDef: ChannelDef<string>, channel: Channel): ChannelDef<string>;
export declare function initFieldOrDatumDef(fd: FieldDef<string, any> | DatumDef, channel: Channel): DatumDef<string, import("./selection").SelectionInit> | {
    /**
     * __Required.__ A string defining the name of the field from which to pull a data value
     * or an object defining iterated values from the [`repeat`](https://vega.github.io/vega-lite/docs/repeat.html) operator.
     *
...
export declare function initFieldDef(fd: FieldDef<string, any>, channel: Channel): {
    /**
     * __Required.__ A string defining the name of the field from which to pull a data value
     * or an object defining iterated values from the [`repeat`](https://vega.github.io/vega-lite/docs/repeat.html) operator.
     *
    ...
    sort?: "ascending" | "descending" | number[] | string[] | boolean[] | DateTime[] | import("./sort").EncodingSortField<string>;
    /**
     * __Required.__ A string defining the name of the field from which to pull a data value
     * or an object defining iterated values from the [`repeat`](https://vega.github.io/vega-lite/docs/repeat.html) operator.
     *
...
export declare function isFieldDefWithCustomTimeFormat(fieldOrDatumDef: TypedFieldDef<string> | DatumDef): boolean;
/**
 ...
 */
export declare function valueExpr(v: number | string | boolean | DateTime | SignalRef | number[], { timeUnit, type, time, undefinedIfExprNotRequired }: {
    timeUnit: TimeUnit | TimeUnitParams;
    type?: Type;
    time?: boolean;
