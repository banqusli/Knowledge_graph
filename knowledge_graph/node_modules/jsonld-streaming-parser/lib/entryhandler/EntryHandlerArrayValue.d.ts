...
export declare class EntryHandlerArrayValue implements IEntryHandler<boolean> {
    ...
    protected handleListElement(parsingContext: ParsingContext, util: Util, value: RDF.Term | null, depth: number, listRootKeys: string[], listRootDepth: number): Promise<void>;
}
